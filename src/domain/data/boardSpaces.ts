...
// rulebook spaces (Opportunity, The Market, Expense, Charity, Baby ×3, Downsized)
...
const RR_PLAN: Record<number, { type: SpaceType; label: string; deck?: CardType }> = {
  ...
  13: { type: 'doodad', label: 'Expense' },
  15: { type: 'doodad', label: 'Expense' },
